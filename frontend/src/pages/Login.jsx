...
import { Mail, Lock, Eye, EyeOff, LogIn, FileText, Loader2 } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1.5rem', background: 'linear-gradient(135deg, #f9fafb 0%, #ecfdf5 100%)' }}>
      <div className="glass-panel animate-fade-in" style={{ width: '100%', maxWidth: '440px', padding: '2.5rem 2rem', backgroundColor: '#ffffff', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.08), 0 10px 10px -5px rgba(0, 0, 0, 0.04)' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '1.75rem', fontWeight: 800, color: '#111827' }}>Welcome Back</h1>
        ...
        <div style={{ textAlign: 'center', marginTop: '1.75rem', fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
          ...
          <Link to="/signup" style={{ color: 'var(--accent-primary)', fontWeight: 700, textDecoration: 'none' }}>
            Create an Account
          </Link>
        </div>
